  ...
  return (
    <div>
      <header className="p-4 bg-black h-14">
        <h1 className="text-emerald-600 text-4xl  inline absolute ml-8 top-2">Hassan</h1>
        <nav className="absolute left-1/3">
          ...
          <button className="w-24 h-10 ml-72 bg-emerald-600 inline rounded-md absolute left-96 -bottom-8">Register</button>
        </nav>
      </header>
    </div>
  );
